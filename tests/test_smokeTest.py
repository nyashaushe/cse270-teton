...
class TestSmokeTest():
  ...
  def test_homepage(self):
      ...
      # Wait for up to 5 seconds for the spotlight images to appear
      WebDriverWait(self.driver, 5).until(lambda d: len(d.find_elements(By.CSS_SELECTOR, ".spotlight1 img")) > 0)
      WebDriverWait(self.driver, 5).until(lambda d: len(d.find_elements(By.CSS_SELECTOR, ".spotlight2 img")) > 0)
      ...
      assert len(elements) > 0
      # The following line may not be valid for your HTML, so it is commented out
